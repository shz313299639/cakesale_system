...
public class FahuoServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(adminlogin != null && adminlogin.get(3).equals("0")){
			request.setAttribute("message", "您的身份不能操作项目！");
			str = "/admin/modifypwd.jsp";
		}else{
			String sql = "update orders set fahuo='已发货',huifu='"+huifu+"',adminid="+adminlogin.get(0)+" where id="+id;
